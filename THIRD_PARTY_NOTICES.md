...
Sora Files uses the following open-source libraries for local file processing. Complete license texts are included in each installed package and remain available from the linked source repositories.
