...
| Plan | Amount | Permanently bound devices |
| --- | ---: | ---: |
...
Each successfully activated paid seat is permanently device-bound. No customer deactivation or transfer endpoint is exposed. Preserve the permanent-device ledger in backups and migrations; provider-side seat removal does not free a SoraFiles seat.
