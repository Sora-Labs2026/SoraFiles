...
- Current local checks: 97 JavaScript tests and 19 native tests pass; the OS credential-store test is deliberately ignored in unattended CI and was run separately on Windows.
