...
try{
 ...
 const explorerToggle=page.getByLabel('Show Open in SoraFiles in Explorer');
 ...
 assert.equal(await page.getByLabel('Show Open in SoraFiles in Explorer').isDisabled(),true);
