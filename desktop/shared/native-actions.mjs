...
const definitions=[
 ...
 {id:'convert-to-webp',tool:'image-converter',label:'Convert to WebP',many:'Convert all to WebP',formats:[...stillImages,'GIF','TIFF'],target:'WebP',direct:true,options:{format:'webp',quality:85}},
