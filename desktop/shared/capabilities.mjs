...
export const capabilities=Object.freeze(liveTools.map(t=>Object.freeze({id:t.id,name:t.name,route:'/'+t.slug,formats:t.inputFormats,outputs:t.outputFormats,mode:combine.has(t.id)?'combine':interactive.has(t.id)?'interactive':'per-file',aliases:[t.name.toLowerCase(),t.id.replaceAll('-',' ')]})));
