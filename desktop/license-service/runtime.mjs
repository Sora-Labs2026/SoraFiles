...
export async function createLicenseRuntime({databasePath,apiKey,mode='test_mode',catalogConfig,signing,challengeSecret,rateSecret,webhookSecret,promotionConfig=null,replacementConfig=null,onFailure=()=>{}}){
