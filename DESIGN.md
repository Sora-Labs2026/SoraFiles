...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#171717` | text, border, background | 3077 |
| `#ebebeb` | border, background | 2462 |
...
- **Geist** — used for all (2841 elements)
- **geistMonoFont** — used for all (322 elements)
...
`400` (2858x), `500` (245x), `600` (58x), `700` (2x)
...
- 1270 !important rules — prefer specificity over overrides
- 12213 duplicate CSS declarations
