...
export const ocrMessages: Record<LocalePath, OcrMessages> = {
  en: {
    ...
    automaticFallback: 'Scanned pages are automatically turned into selectable text on your device.',
    inspecting: 'Inspecting PDF pages for readable text…',
    loadingModel: 'Preparing text recognition ({code})…',
    recognizingPage: 'Recognizing scanned page {current} of {total}…',
    ocrSummary: 'Text recognized on {pages} scanned page(s).',
    lowConfidence: 'Page {current} may contain recognition mistakes. Double-check the output text.',
    tooManyScans: 'More than 20 pages require OCR. Processing may take a few minutes.',
    unavailable: 'Text recognition could not start. Only existing text was extracted.',
    cancel: 'Cancel text recognition',
    cancelled: 'Text recognition cancelled.',
    layoutWarning:
      'Complex layouts may become simpler paragraphs. Recognition accuracy depends on scan clarity, language, handwriting, and page layout.',
  },
  ja: {
