...
export const brandPositioning: Record<LocalePath, BrandPositioning> = {
  en: {
    ...
    heroLine2: 'File App.',
    aboutTitle: 'One file app. Private by architecture.',
    ...
    oneAppA: 'One', oneAppB: 'File App', oneAppSummary: 'PDF and image workflows in one place.',
    footerTagline: 'by Sora Labs — a privacy-first file app that runs locally in your browser.',
  },
  ja: {
    ...
    heroLine1: 'プライバシー重視の', heroLine2: 'ファイルアプリ。',
    aboutTitle: 'ひとつのファイルアプリ。設計からプライベート。',
    aboutIntro: 'SoraFilesは、ブラウザ上で直接ファイルを扱うためにSora Labsが開発した、プライバシー重視のWebアプリです。対応するファイル処理はお使いの端末内で行われます。',
    oneAppA: 'ひとつの', oneAppB: 'アプリ', oneAppSummary: 'PDFと画像の作業を一か所で。',
    footerTagline: 'Sora Labs開発 — ブラウザ内でローカルに動く、プライバシー重視のファイルアプリ。',
  },
  ko: {
    ...
    heroLine1: '개인정보 보호 중심', heroLine2: '파일 앱.',
    aboutTitle: '하나의 파일 앱. 설계부터 프라이빗하게.',
    aboutIntro: 'SoraFiles는 브라우저에서 파일을 직접 다루기 위해 Sora Labs가 만든 개인정보 보호 중심 웹 애플리케이션입니다. 지원되는 파일 처리는 사용자의 기기에서 로컬로 실행됩니다.',
    oneAppA: '하나의', oneAppB: '파일 앱', oneAppSummary: 'PDF와 이미지 작업을 한곳에서.',
    footerTagline: 'Sora Labs 제작 — 브라우저에서 로컬로 실행되는 개인정보 보호 중심 파일 앱.',
  },
  es: {
    ...
    heroLine1: 'Una app de archivos', heroLine2: 'centrada en la privacidad.',
    aboutTitle: 'Una sola app de archivos. Privada por arquitectura.',
    ...
    oneAppA: 'Una sola', oneAppB: 'App', oneAppSummary: 'Flujos de PDF e imágenes en un solo lugar.',
    footerTagline: 'de Sora Labs — una app de archivos privada que se ejecuta localmente en tu navegador.',
  },
  fr: {
    ...
    heroLine1: 'Une application de fichiers', heroLine2: 'axée sur la confidentialité.',
    ...
    oneAppA: 'Une seule', oneAppB: 'Application', oneAppSummary: 'Les flux PDF et image au même endroit.',
    footerTagline: 'par Sora Labs — une application de fichiers privée qui s’exécute localement dans votre navigateur.',
  },
  de: {
    ...
    heroLine1: 'Eine datenschutzorientierte', heroLine2: 'Datei-App.',
    aboutTitle: 'Eine Datei-App. Privat durch Architektur.',
    ...
    oneAppA: 'Eine', oneAppB: 'Datei-App', oneAppSummary: 'PDF- und Bildabläufe an einem Ort.',
    footerTagline: 'von Sora Labs — eine datenschutzorientierte Datei-App, die lokal in deinem Browser läuft.',
  },
  pt: {
    ...
    heroLine1: 'Uma aplicação de ficheiros', heroLine2: 'focada na privacidade.',
    ...
    oneAppA: 'Uma só', oneAppB: 'Aplicação', oneAppSummary: 'Fluxos de PDF e imagem num só lugar.',
    footerTagline: 'da Sora Labs — uma aplicação de ficheiros privada que funciona localmente no navegador.',
  },
  'zh-cn': {
    homeTitle: 'SoraFiles - 在浏览器中私密处理文件',
    description: 'SoraFiles 是一款注重隐私的 Web 应用，可直接在浏览器中处理 PDF 和图像。受支持的文件处理会在你的设备上本地完成。',
    heroLine1: '一款注重隐私的', heroLine2: '文件应用。',
    aboutTitle: '一个文件应用，从架构上保护隐私。',
    aboutIntro: 'SoraFiles 是 Sora Labs 打造的注重隐私的 Web 应用，用于直接在浏览器中处理文件。受支持的文件处理会在你的设备上本地完成。',
    oneAppA: '一个', oneAppB: '文件应用', oneAppSummary: '集中完成 PDF 和图像工作。',
    footerTagline: '由 Sora Labs 打造 — 在浏览器中本地运行的隐私优先文件应用。',
  },
  'zh-tw': {
    homeTitle: 'SoraFiles - 在瀏覽器中私密處理檔案',
    description: 'SoraFiles 是一款重視隱私的 Web 應用程式，可直接在瀏覽器中處理 PDF 與影像。支援的檔案處理會在你的裝置上本機完成。',
    heroLine1: '一款重視隱私的', heroLine2: '檔案應用程式。',
    aboutTitle: '一個檔案應用程式，從架構保護隱私。',
    aboutIntro: 'SoraFiles 是 Sora Labs 打造的隱私優先 Web 應用程式，用於直接在瀏覽器中處理檔案。支援的檔案處理會在你的裝置上本機完成。',
    oneAppA: '一個', oneAppB: '檔案應用程式', oneAppSummary: '集中完成 PDF 與影像工作。',
    footerTagline: '由 Sora Labs 打造 — 在瀏覽器中本機執行的隱私優先檔案應用程式。',
  },
  hi: {
    ...
    heroLine1: 'गोपनीयता-प्रथम', heroLine2: 'फ़ाइल ऐप।',
    aboutTitle: 'एक फ़ाइल ऐप। बनावट से ही निजी।',
    ...
    oneAppA: 'एक', oneAppB: 'फ़ाइल ऐप', oneAppSummary: 'PDF और इमेज के काम एक ही जगह।',
    footerTagline: 'Sora Labs द्वारा — ब्राउज़र में स्थानीय रूप से चलने वाला गोपनीयता-प्रथम फ़ाइल ऐप।',
  },
  ar: {
    ...
    heroLine1: 'تطبيق ملفات', heroLine2: 'يضع الخصوصية أولًا.',
    aboutTitle: 'تطبيق ملفات واحد. خاص بحكم بنيته.',
    ...
    oneAppA: 'تطبيق', oneAppB: 'واحد', oneAppSummary: 'مهام PDF والصور في مكان واحد.',
    footerTagline: 'من Sora Labs — تطبيق ملفات يضع الخصوصية أولًا ويعمل محليًا داخل متصفحك.',
  },
  ru: {
    ...
    heroLine1: 'Файловое приложение', heroLine2: 'с приоритетом приватности.',
    aboutTitle: 'Одно файловое приложение. Приватное по архитектуре.',
    ...
    oneAppA: 'Одно', oneAppB: 'Приложение', oneAppSummary: 'Работа с PDF и изображениями в одном месте.',
    footerTagline: 'от Sora Labs — приватное файловое приложение, которое работает локально в вашем браузере.',
  },
  id: {
    ...
    heroLine1: 'Aplikasi file', heroLine2: 'yang mengutamakan privasi.',
    aboutTitle: 'Satu aplikasi file. Privat dari arsitekturnya.',
    ...
    oneAppA: 'Satu', oneAppB: 'Aplikasi', oneAppSummary: 'Alur PDF dan gambar di satu tempat.',
    footerTagline: 'dari Sora Labs — aplikasi file privat yang berjalan secara lokal di browser Anda.',
  },
  it: {
    ...
    heroLine1: 'Un’app per file', heroLine2: 'orientata alla privacy.',
    aboutTitle: 'Una sola app per file. Privata per architettura.',
    ...
    oneAppA: 'Una sola', oneAppB: 'App', oneAppSummary: 'Flussi PDF e immagini in un unico posto.',
    footerTagline: 'di Sora Labs — un’app per file privata che funziona localmente nel tuo browser.',
  },
  nl: {
    ...
    heroLine1: 'Een privacygerichte', heroLine2: 'bestandsapp.',
    aboutTitle: 'Eén bestandsapp. Privé door de architectuur.',
    ...
    oneAppA: 'Eén', oneAppB: 'Bestandsapp', oneAppSummary: 'Pdf- en afbeeldingswerkstromen op één plek.',
    footerTagline: 'van Sora Labs — een privacygerichte bestandsapp die lokaal in je browser draait.',
  },
  tr: {
    ...
    heroLine1: 'Gizlilik odaklı', heroLine2: 'dosya uygulaması.',
    aboutTitle: 'Tek dosya uygulaması. Mimarisi gereği gizli.',
    ...
    oneAppA: 'Tek', oneAppB: 'Uygulama', oneAppSummary: 'PDF ve görsel iş akışları tek yerde.',
    footerTagline: 'Sora Labs tarafından — tarayıcınızda yerel çalışan gizlilik odaklı dosya uygulaması.',
  },
  vi: {
    ...
    heroLine1: 'Ứng dụng tệp', heroLine2: 'ưu tiên quyền riêng tư.',
    aboutTitle: 'Một ứng dụng tệp. Riêng tư từ kiến trúc.',
    ...
    oneAppA: 'Một', oneAppB: 'Ứng dụng', oneAppSummary: 'Quy trình PDF và hình ảnh ở một nơi.',
    footerTagline: 'từ Sora Labs — ứng dụng tệp ưu tiên quyền riêng tư chạy cục bộ trong trình duyệt.',
  },
  th: {
    ...
    heroLine1: 'แอปไฟล์ที่ให้ความสำคัญ', heroLine2: 'กับความเป็นส่วนตัว',
    aboutTitle: 'แอปไฟล์เดียว เป็นส่วนตัวด้วยสถาปัตยกรรม',
    ...
    oneAppA: 'หนึ่ง', oneAppB: 'แอปไฟล์', oneAppSummary: 'งาน PDF และรูปภาพในที่เดียว',
    footerTagline: 'โดย Sora Labs — แอปไฟล์ที่ให้ความสำคัญกับความเป็นส่วนตัวและทำงานในเบราว์เซอร์ของคุณ',
  },
  pl: {
    ...
    heroLine1: 'Aplikacja do plików', heroLine2: 'stawiająca prywatność na pierwszym miejscu.',
    aboutTitle: 'Jedna aplikacja do plików. Prywatna z założenia.',
    ...
    oneAppA: 'Jedna', oneAppB: 'Aplikacja', oneAppSummary: 'Obsługa PDF-ów i obrazów w jednym miejscu.',
    footerTagline: 'od Sora Labs — prywatna aplikacja do plików działająca lokalnie w Twojej przeglądarce.',
  },
};
