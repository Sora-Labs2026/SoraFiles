...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: 'Reduce a PDF file size while keeping the document clear.',
    href: '/pdf',
    icon: 'compress',
    tone: 'coral',
    badge: 'Popular',
  ...
  },
  {
    ...
    accept: 'application/pdf,.pdf',
    multiple: false,
    caution: 'Complex layouts may become simpler paragraphs. Scanned text is recognized on your device; accuracy depends on scan clarity, language, handwriting, and page layout.',
    category: 'convert',
    formats: ['PDF', 'DOCX'],
