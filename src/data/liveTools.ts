...
const define = (tool: Omit<LiveTool, 'name' | 'description' | 'tagline'>): LiveTool => {
...
export const liveTools: LiveTool[] = [
  define({ slug: 'pdf', id: 'compress-pdf', icon: 'compress', engine: 'compressPdf', tile: 'from-rose-500 to-red-600 shadow-rose-500/30', tint: 'border-rose-100 bg-rose-50/80 hover:border-rose-200 dark:border-rose-400/10 dark:bg-rose-500/[0.07]', accept: PDF, multiple: false, reorder: false, outputLabel: 'PDF', limitationKey: 'lim.compress', related: ['merge-pdf', 'split-pdf', 'pdf-to-jpg'] }),
